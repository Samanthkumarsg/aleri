            ...
            <div className="container flex flex-wrap justify-between items-center mx-auto py-4">
                ...
                <div className="flex md:order-2">
                    <div className="hidden relative mr-3 md:mr-0 md:block">
                        <button className='border border-gray-800 bg-gray-800 text-white hover:bg-white hover:text-gray-800 rounded-md px-4 py-1 text-sm '>Donate</button>
                    </div>
                ...
                <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-3">
                    <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        ...
                        <Link href="">
                            <p className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Gallery</p>
                        </Link>
                    </ul>
                </div>
            </div>
